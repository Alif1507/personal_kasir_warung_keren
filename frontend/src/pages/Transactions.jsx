...
import { Receipt, Eye, X, ChevronDown } from "lucide-react";
...
export default function Transactions() {
  ...
  return (
    <div className="animate-fade-in">
      {/* Header */}
      <div className="mb-4">
        <h2 className="text-4xl font-extrabold text-[var(--color-text)] tracking-tight" style={{ fontFamily: "var(--font-display)" }}>
          Riwayat
        </h2>
      ...
      {/* Detail Bottom Sheet */}
      {selected && (
        <div className="fixed inset-0 z-50 top-100">
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setSelected(null)} />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white rounded-t-3xl p-5 pb-8 animate-slide-up">
