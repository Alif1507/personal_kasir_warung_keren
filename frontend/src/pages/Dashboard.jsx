    ...
    <div className="space-y-5 animate-fade-in">
      ...
      >
        ...
        <div className="flex items-center gap-1 mt-2 text-white/80 text-xs font-medium">
          ...
          <span>{stats.total_orders} pesanan hari ini</span>
        </div>
      </div>
      ...
      {/* FAB — New Order */}
      <div className="fixed top-[115%] left-1/2 -translate-x-1/2 w-full max-w-[430px] pointer-events-none px-6 flex justify-end z-40">
        <button
